				...
				process={{
					...
					steps: [
						...
						},
						{
							...
							description:
								'We built a custom WordPress theme using a modern WordPress block theme, implementing the exceptional design work from <a href="https://www.yetiisland.studio/" target="_blank" rel="noopener noreferrer" className="text-cyber-green hover:text-white transition-colors">Yeti Island Studio</a>. The theme includes custom post types for customer stories and job listings, sophisticated block editor integration, and a modular architecture designed for maintainability and future growth.',
							details: [
