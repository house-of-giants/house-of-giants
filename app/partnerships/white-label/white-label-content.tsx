						...
						<div className="bg-card/30 border-border relative overflow-hidden rounded-2xl border p-8 md:p-12 lg:p-16">
							...
							<div className="relative z-10">
								...
								<p className="text-muted-foreground mb-6 text-lg leading-relaxed">
									We operate under your flag. Your clients never see &quot;House of Giants.&quot; 
									We use your brand handles, your communication channels, and your project management tools.
								</p>
				...
				<Section className="text-center">
					<div className="mx-auto max-w-3xl">
						...
						<p className="body-large text-muted-foreground mb-10">
							Give your agency the technical backbone it deserves. 
							Let&apos;s discuss which pod configuration fits your current pipeline.
						</p>
						...
						<div className="flex flex-col items-center gap-6">
							...
							<p className="text-muted-foreground text-sm">
								No sales reps. Direct access to technical principals.
							</p>
						</div>
					</div>
				</Section>
