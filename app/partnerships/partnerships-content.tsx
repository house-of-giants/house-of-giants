...
const partnershipTypes = [
	{
		...
		description: 'A fully managed engineering team that lives under your brand. We handle the code, you own the client.',
		icon: Shield,
	...
	},
	{
		...
		description: 'Mutually beneficial referral loops for consultants, CTOs, and strategists. We build what you architect.',
		icon: Handshake,
		href: '/contact?source=partnership-strategic',
		cta: 'Join the Network',
		features: ['Vetted referral fees', 'Technical feasibility audits', 'Joint pitch support', 'Long-term collaboration'],
	},
	{
		title: 'Venture',
		subtitle: 'Equity & Growth',
		description: 'Deep technical partnerships for venture studios and early-stage accelerators. We build the foundation.',
		icon: Rocket,
			...
			<main>
				...
				>
					...
					<div className="container-wide relative z-10 text-center">
						...
						>
							We don&apos;t just build websites. We build technical infrastructure that helps agencies scale, 
							consultants look like heroes, and startups get funded. No bullshit, just results.
						</p>
					</div>
				</Section>
						...
						{partnershipTypes.map((type, index) => {
							...
							return (
								<div
									key={type.title}
									className={cn(
										'bg-background group border-border hover:border-primary/50 relative flex flex-col overflow-hidden rounded-2xl border p-8 transition-all hover:shadow-lg lg:p-10 opacity-0',
										mounted && 'animate-slide-up'
									)}
					...
					<div className="grid gap-16 lg:grid-cols-2 lg:items-center">
						<div>
							...
							<div className="grid gap-6 sm:grid-cols-2">
								<div className="space-y-2">
									...
									<p className="text-muted-foreground text-sm">No learning on your dime. You work directly with architects who ship.</p>
								</div>
								<div className="space-y-2">
									<h4 className="text-foreground font-bold">Principal-Led</h4>
									<p className="text-muted-foreground text-sm">Direct lines of communication. Fast decisions. Zero bureaucracy.</p>
								</div>
								<div className="space-y-2">
									<h4 className="text-foreground font-bold">Battle-Tested Stack</h4>
									<p className="text-muted-foreground text-sm">We bring our Pod OS—a proven toolchain for high-velocity delivery.</p>
								</div>
								<div className="space-y-2">
									<h4 className="text-foreground font-bold">Reliable Velocity</h4>
									<p className="text-muted-foreground text-sm">Predictable monthly capacity that scales with your pipeline.</p>
								</div>
							</div>
						</div>
						...
						<div className="bg-card/50 border-border relative overflow-hidden rounded-2xl border p-8 md:p-12">
							...
							<blockquote className="relative z-10">
								<p className="text-foreground mb-6 text-xl font-medium leading-relaxed italic">
									&quot;Partnering with House of Giants allowed us to say &apos;yes&apos; to high-value technical builds we used to turn away. 
									They aren&apos;t just a vendor; they&apos;re an invisible engine for our growth.&quot;
								</p>
				...
				<Section className="text-center">
					<div className="mx-auto max-w-3xl">
						...
						<p className="body-large text-muted-foreground mb-10">
							Whether you need an invisible dev team or a strategic technical partner, 
							we&apos;re here to make you (and your clients) look like heroes.
						</p>
