		...
		<main>
			...
			<Section>
				<div className="grid gap-12 lg:grid-cols-[1.5fr_1fr] lg:gap-16">
					<div>
						{state.success ? (
							<div className="bg-background/50 border-border flex flex-col items-center justify-center border p-12 text-center backdrop-blur-sm">
							...
							<form key={formKey} action={formAction} aria-label="Contact form" className="space-y-6">
								...
								<div className="pt-4">
									{state.error && (
										<div role="alert" className="bg-destructive/10 text-destructive mb-4 p-4 text-sm">
											{state.error}
										</div>
									)}
					...
					<div className="order-first space-y-8 lg:order-last">
						<div className="bg-primary/10 border-primary/20 border p-6 text-center">
						...
						<div>
							...
							<div className="grid grid-cols-3 gap-4">
								{featuredClients.map((client) => (
									<div
										key={client.name}
										className="bg-background/50 border-border hover:border-primary/30 flex aspect-[3/2] items-center justify-center border p-3 transition-colors"
									>
										<Image
											src={client.logo}
											alt={client.name}
