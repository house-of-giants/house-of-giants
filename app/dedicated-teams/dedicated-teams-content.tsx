				...
				<div className="bg-card/30 border-border mt-24 overflow-hidden border md:mt-32">
					...
					<div className="bg-muted/10 p-4 px-8">
						<p className="text-muted-foreground text-[11px] leading-relaxed">
							* We provide the full infrastructure and toolchain by default. If you have legacy systems, we bridge them
							into our process for maximum velocity.
						</p>
					</div>
				</div>
			</Section>
			...
			<Section className="bg-muted/20">
				...
				<div className="grid gap-8 lg:grid-cols-2">
					{podCaseStudies.map((study, index) => (
						<CaseStudyCard key={study.slug} study={study} variant="minimal" index={index} />
					))}
				</div>
			</Section>
