	...
	return (
		<main>
			<PageHeader
				...
				description="We're a founder-led custom web development partner for startups and scale-ups who care about craft. No bloat, no templates. Just high quality code that drives revenue."
			/>
			...
			<Section className="overflow-hidden">
				...
				<div className="grid grid-cols-1 gap-6 md:grid-cols-2">
					<div className="bg-background group border-border hover:border-primary/50 relative overflow-hidden border p-8 transition-colors">
					...
					<div className="bg-background group border-border hover:border-primary/50 relative overflow-hidden border p-8 transition-colors">
						...
						<p className="text-muted-foreground leading-relaxed">
							We pick the right stack for the job, not the one we know best. Whether it&apos;s a headless CMS, a complex
							React app, or a performance-first marketing site, we solve for outcomes, not frameworks.
						</p>
					</div>
					...
					<div className="bg-background group border-border hover:border-primary/50 relative overflow-hidden border p-8 transition-colors">
						...
						<p className="text-muted-foreground leading-relaxed">
							Born in Denver with a &quot;question everything&quot; approach to digital: small, fast, and fiercely
							independent. We bring Colorado&apos;s grounded, no-bullshit culture to everything we build for our
							national partners.
						</p>
					</div>
				</div>
			...
			<Section>
				...
				<div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
					<div className="bg-muted/30 border-border relative aspect-square overflow-hidden border">
					...
					<div>
						...
						<div className="mt-8 flex flex-wrap gap-3">
							<span className="border-border bg-card/50 inline-flex items-center gap-2 border px-4 py-2 text-sm">
			...
			<Section padding="bottom">
				...
				<div className="border-border bg-background relative overflow-hidden border p-8 md:p-12 lg:p-16">
						...
						<div className="bg-card/50 border-primary/20 relative w-full max-w-xs overflow-visible border filter transition-all hover:grayscale-0 lg:w-1/2">
							...
							<div className="relative aspect-4/3 w-full">
								...
								<div className="absolute top-[32%] left-[55%] z-20 translate-x-1/2 translate-y-1/2">
									<div className="bg-primary/20 absolute -inset-4 animate-ping" />
									<div className="bg-primary relative size-3 shadow-[0_0_20px_var(--color-primary)]" />
								</div>
							</div>
						</div>
					</div>
