	...
	return (
		<div ref={containerRef} className="bg-[--c-primary-dark] min-h-screen">
			...
			<div className="relative">
				...
				{/* Challenge & Solution */}
				{(challenge || solution) && (
					<div ref={containerRef} className="relative z-10 max-w-[var(--container-width)] mx-auto px-4 md:px-8 py-32">
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
							{challenge && (
								...
								>
									<h3 className="text-2xl font-bold text-cyber-green">The Challenge</h3>
									<p className="text-xl text-moon-rock leading-relaxed">{challenge}</p>
								</motion.div>
							)}
							{solution && (
								<motion.div
								...
								>
									<h3 className="text-2xl font-bold text-cyber-green">The Solution</h3>
									<p className="text-xl text-moon-rock leading-relaxed">{solution}</p>
								</motion.div>
							)}
						</div>
					</div>
