		...
		<div className="service-card group relative p-8 rounded-lg border border-moon-rock/10 hover:border-transparent transition-all duration-500">
			...
			<div className="relative space-y-8">
				...
				<div className="space-y-6">
					<h3 className="text-[clamp(2rem, 4vw, 3.5rem)] font-normal not-italic leading-none tracking-tight group-hover:-grad-header transition-colors text-moon-rock duration-300">
						{title}
					</h3>
