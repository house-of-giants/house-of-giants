...
export default function Home() {
  ...
  const onSubmit = async (data) => {
    ...
    fetchJson("/api/send-email", {
      ...
      if (status === 200) {
        ...
        setContactSuccess(
          "We're pumped to work with you! We'll reach back out as soon as possible."
        );
      } else {
        const { message } = data;
  ...
  const kellyAnim = useTransform(
    scrollYProgress,
    [0.75, 0.8],
    [isBig ? 400 : 0, 0]
  );
  const domAnim = useTransform(
    scrollYProgress,
    [0.7, 0.8],
    [isBig ? 550 : 0, 0]
  );
  const danielAnim = useTransform(
    scrollYProgress,
    [0.7, 0.8],
    [isBig ? 250 : 0, 0]
  );
  const teamOpacityAnim = useTransform(
    scrollYProgress,
    [0.7, 0.8],
    [isBig ? 0 : 1, 1]
  );
    ...
    <>
      ...
      >
        <Dots>
          ...
          <p className="h2 -uppercase -lh-2 -m-sm">
            Dreaming of innovation. Experimenting with passion. Creating with
            purpose. We are a Digital Interactive Studio Focused on creating{" "}
            <span className="-cross">fucking</span> beautiful, bold,
        ...
        <Grid cols="1.75fr 1fr" gap="var(--sp-2xl)" pBottom="var(--sp-2xl)">
          <h2 className="-lh-1 -m0 -fs-2xl -dots">
            <span className="-grad-header">
              We&apos;ll handle the black magic so you don&apos;t have to dabble
              in the dark arts.
            </span>
          </h2>
          <p className="-c-wolf-gray -m0">
            Denver based and Colorado raised, we have been honing our craft for
            over a decade. From strategy to user experience, to design and
            development, we know how to creatively solve complex problems on the
            web.
          </p>
        </Grid>
        <Grid
        ...
        >
          <Grid cols="1fr 10fr" gap="var(--sp-m)" align="start">
            ...
            <div>
              ...
              <p className="-m0">
                ...
                <br />
                Dwayne "The Rock" Johnson. Each project we are a part of
                deserves a thoughtful and detail oriented approach. We'll work
                with you as a strategic partner to establish the best path
                forward for your specific needs.
              </p>
            </div>
          </Grid>
          ...
          <Grid cols="1fr 10fr" gap="var(--sp-m)" align="start">
            ...
            <div>
              ...
              <p className="-m0">
                User experience strategy and design is unique to your project.
                We&apos;re not going to throw trashy buzzwords your way unless
                they'll provide true benefit to you and your users.
              </p>
            </div>
          </Grid>
        </Grid>
        ...
        >
          <Grid cols="1fr 10fr" gap="var(--sp-m)" align="start">
            ...
            <div>
              ...
              <p className="-m0">
                We&apos;ve worked our asses off to be able flex our creative
                muscles at will, and we are{" "}
                <strong>
                  <em>ripped</em>
                </strong>
                . We get pumped up like Arnold to be able to show you the unique
                visual designs we come up with for your brand.
              </p>
            </div>
          </Grid>
          ...
          <Grid cols="1fr 10fr" gap="var(--sp-m)" align="start">
            ...
            <div>
              <h4>Development</h4>
              <p className="-m0">
                We take an absurd amount of pride in the code we write.
                Performace, accessibility, and scalability are built into
                everything we do from the start. Your socks won't grow with your
                feet. On the other foot, our code will grow with you as your
                business scales.
              </p>
            </div>
          </Grid>
      ...
      >
        ...
        <Grid cols="1.75fr 1fr" gap="var(--sp-2xl)" pBottom="var(--sp-2xl)">
          ...
          <p className="-c-wolf-gray -m0">
            This is just a short list of the kick ass partners we&apos;ve worked
            with. A tiny logo in a trust bar will never express the true
            gratitude for every partner we&apos;ve engaged with over the years.
          </p>
        </Grid>
        <Grid
          cols="repeat(auto-fit, minmax(114px, 220px))"
          pTop="var(--sp-2xl)"
          gap="var(--sp-xl)"
          justify="center"
        >
        ...
        >
          <div>
            <blockquote>
              They even took the time for in-depth research before calls which
              proved to me they understood the history and path.
            </blockquote>
            <figcaption>
              Bodie Johnson
              <br />
          ...
          <div>
            <blockquote>
              I was most impressed with how seriously they took my ideas and
              incorporated them into their awesome design ability.
            </blockquote>
            <figcaption>
              Sheryl Glubok
              <br />
          ...
          <div>
            <blockquote>
              The outcome has been fantastic, as we&apos;re successfully
              generating new people who want to get involved in our program.
            </blockquote>
            <figcaption>
              Ann Marie Beresford
              <br />
          ...
          <div>
            <blockquote>
              They do a great job at getting to know the brand and investing in
              our collaboration.
            </blockquote>
            <figcaption>
              Katie Zak
      ...
      >
        ...
        <Grid cols="1.75fr 1fr" gap="var(--sp-2xl)" pBottom="var(--sp-2xl)">
          <h2 className="-lh-1 -m0 -fs-2xl -grad-header">
            We are a three person team kicking ass
          </h2>
          <p className="-c-wolf-gray -m0">
            Ten years of dreaming, aspiring, and pushing each other to be
            creative in the pursuit of lifelong web design and development
            mastery.
          </p>
        </Grid>
        ...
        <Grid cols="repeat(3, 1fr)" gap="var(--sp-m)" pBottom="var(--sp-2xl)">
          <motion.div
            style={{ y: danielAnim, opacity: teamOpacityAnim }}
            className="-stagger"
          >
            <StyledGridItem>
          ...
          <motion.div
            style={{ y: kellyAnim, opacity: teamOpacityAnim }}
            className="-stagger"
          >
            <StyledGridItem>
              <div className="team-img">
          ...
          <motion.div
            style={{ y: domAnim, opacity: teamOpacityAnim }}
            className="-stagger"
          >
            <StyledGridItem>
              <div className="team-img">
      ...
      >
        ...
        >
          <Dots opacity="0.1">
            <h2 className="-lh-1 -fw-700">
              Let&apos;s build something amazing together
            </h2>
            <p>
              Whether you have a fully fleshed out idea, or just want to talk
              through options, we'd love to chat with you. Give us some quick
              information that will help us better understand your needs, and
              we'll let you know the options.
            </p>
        ...
        <div className="form" onClick={() => setShowForm(true)}>
          {!contactSuccess ? (
            ...
            <AnimatePresence>
              ...
              >
                🤘 Thanks for reaching out! We'll get in touch with you as
                quickly as possible.
              </motion.h2>
            </AnimatePresence>
          )}
      ...
      <StyledSocial className={showForm ? "-active" : ""}>
        <Container pBottom="var(--sp-s)">
          <ul>
            ...
            <li>
              <a
                href="https://www.instagram.com/_houseofgiants/"
                target="_blank"
                rel="noopener"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/company/house-of-giants"
                target="_blank"
                rel="noopener"
              >
            ...
            <li>
              <a
                ...
                rel="noopener"
              >
                Best website design <Arrow width="10" height="10" />
              </a>
            </li>
          </ul>

          <p className="-fw-500 -m0">
            &copy;{new Date().getFullYear()} House of Giants
          </p>
        </Container>
      </StyledSocial>
    </>
